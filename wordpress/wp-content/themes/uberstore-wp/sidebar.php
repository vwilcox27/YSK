...
<aside class="sidebar small-12 medium-4 columns<?php if ($sidebar_pos == 'left') { echo ' pull-eight'; }?><?php if (is_page_template('template-portfolio.php') || is_page_template('template-portfolio-paginated.php')) { echo ' no-border'; } ?>">
	<?php 
