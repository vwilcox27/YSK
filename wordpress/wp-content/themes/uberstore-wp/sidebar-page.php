...
<aside class="sidebar small-12 medium-3 columns<?php if ($sidebar_pos == 'left') { echo ' medium-pull-9'; }?><?php if (is_page_template('template-portfolio.php') || is_page_template('template-portfolio-paginated.php')) { echo ' no-border'; } ?>">
	<?php 
