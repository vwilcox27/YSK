...
$quick_view = ot_get_option('quick_view', 'on'); 
?>

<?php if($sidebar != 'no') { ?>
    <article itemscope itemtype="<?php echo woocommerce_get_product_schema(); ?>" <?php post_class("post small-6 medium-4 columns"); ?>>
<?php } else { ?>
		<article itemscope itemtype="<?php echo woocommerce_get_product_schema(); ?>" <?php post_class("post small-6 medium-3 columns"); ?>>
<?php } ?>
