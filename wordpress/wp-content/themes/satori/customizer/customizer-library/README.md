...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'satori' ), // Required
...
$options['example-text'] = array(
	'id' => 'example-text',
	'label'   => __( 'Example Text Input', 'satori' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-url'] = array(
	'id' => 'example-url',
	'label'   => __( 'Example URL Input', 'satori' ),
	'section' => $section,
	'type'    => 'url',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'satori' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
...
$options['example-select'] = array(
	'id' => 'example-select',
	'label'   => __( 'Example Select', 'satori' ),
	'section' => $section,
	'type'    => 'select',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-dropdown-pages'] = array(
	...
	'label'   => __( 'Example Drop Down Pages', 'satori' ),
	'section' => $section,
	'type'    => 'dropdown-pages',
	'default' => ''
);
