...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'satori' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'satori' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'satori' ),
		'cyrillic'     => __( 'Cyrillic', 'satori' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'satori' ),
		'devanagari'   => __( 'Devanagari', 'satori' ),
		'greek'        => __( 'Greek', 'satori' ),
		'greek-ext'    => __( 'Greek Extended', 'satori' ),
		'khmer'        => __( 'Khmer', 'satori' ),
		'latin'        => __( 'Latin', 'satori' ),
		'latin-ext'    => __( 'Latin Extended', 'satori' ),
		'vietnamese'   => __( 'Vietnamese', 'satori' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'satori' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'satori' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'satori' ),
