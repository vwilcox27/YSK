...
if ( is_active_sidebar( 'pixgraphy_footer_options' ) ) :
		...
		<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
						<?php esc_html_e('Designed by:','pixgraphy'); ?> <a title="<?php echo esc_attr__( 'Theme Freesia', 'pixgraphy' ); ?>" target="_blank" href="<?php echo esc_url( 'http://themefreesia.com' ); ?>"><?php esc_html_e('Theme Freesia','pixgraphy');?></a> | 
