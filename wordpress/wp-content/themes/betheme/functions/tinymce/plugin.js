		...
		editor.addButton('mfnsc', {
			...
			menu : [ {
				...
				menu : [ {
					...
					text : 'Map',
					onclick : function() {
						editor.insertContent('[map lat="" lng="" height="200" zoom="13" icon="" title="" telephone="" email="" www="" latlng=""]Insert your content here[/map]');
					}
				}, {
					text : 'Opening Hours',
					onclick : function() {
					...
					text : 'Shop Slider',
					onclick : function() {
						editor.insertContent('[shop_slider title="" count="5" category="" orderby="date" order="DESC"]');
					}
				}, {
					text : 'Slider',
					onclick : function() {
