	...
	$mfn_page_meta_box = array(
		...
		'fields'	=> array(
			...
			array(
				...
				'sub_desc' 	=> __('Select 2nd sidebar for this page.', 'mfn-opts'),
			...
			array(
				...
				'desc'		=> __('This will also remove Content Padding for pages without sidebar', 'mfn-opts'),
				'options'	=> array('1' => 'On', '0' => 'Off'),
				'std'		=> '0'
			),
			...
			array(
				...
				'desc' 		=> __('Remove default Content Padding for pages without sidebar', 'mfn-opts'),
				'options' 	=> array('1' => 'On','0' => 'Off'),
				'std' 		=> '0'
			),
