					...
					echo '<div id="mfn-aside">';
						...
						echo '<ul class="mfn-menu">';
							...
							echo '<li class="mfn-menu-li mfn-menu-li-import">';
								echo '<a href="javascript:void(0);" class="mfn-menu-a"><span class="icon"></span>'. __('Import & Export', 'mfn-opts'). '</a>';
								echo '<ul class="mfn-submenu">';
									echo '<li id="import-mfn-submenu-li" class="mfn-submenu-li">';
										echo '<a href="javascript:void(0);" class="mfn-submenu-a" data-rel="import"><span>'. __('Import & Export', 'mfn-opts'). '</span></a>';
									echo '</li>';
								echo '</ul>';
							echo '</li>';
						...
						echo '<div class="mfn-header">';
							echo '<div class="mfn-buttons">';
								...
								echo '<div class="mfn-buttons-more">';
									...
									echo '<a class="mfn-btn-doc" href="http://themes.muffingroup.com/'. $this->args['opt_name'] .'/documentation" target="_blank"><span>Documentation</span></a>';
									echo '<a class="mfn-btn-demo" href="http://themes.muffingroup.com?theme='. $this->args['opt_name'] .'" target="_blank"><span>Demo</span></a>';
								echo '</div>';
							echo '</div>';
							...
							foreach($this->sections as $k => $section){
								echo '<div id="'.$k.'-mfn-section'.'" class="mfn-section">';
									...
									echo '<div class="mfn-sections-footer">';
										echo '<input type="submit" name="'. $this->args['opt_name'] . '[defaults]" value="'.__('Reset to Defaults', 'mfn-opts').'" class="mfn-popup-reset" />';
										echo '<input type="submit" name="submit" value="'.__('Save Changes', 'mfn-opts').'" class="mfn-popup-save" />';
									echo '</div>';
								echo '</div>';
							}
								...
								echo '<div class="mfn-import-wrapper">';
									...
									echo '<div class="mfn-import-box mfn-import-imp">';
										...
										echo '<p class="mfn-import-imp-action">';
											...
											echo '<span>'.__('WARNING! This will overwrite any existing options, please proceed with caution!', 'mfn-opts').'</span>';
										echo '</p>';
									...
									echo '<div class="mfn-import-box mfn-import-exp">';
										...
										echo '<p>';
											...
											echo '<a href="'.add_query_arg(array('feed' => 'mfn-opts-'.$this->args['opt_name'], 'action' => 'download_options', 'secret' => md5(AUTH_KEY.SECURE_AUTH_KEY)), site_url()).'" class="mfn-btn mfn-btn-primary mfn-import-exp-download-btn">'.__('Download', 'mfn-opts').'</a>&nbsp;';
										...
										echo '</textarea>';
										echo '<input type="text" class="large-text mfn-import-exp-link" value="'.add_query_arg(array('feed' => 'mfn-opts-'.$this->args['opt_name'], 'secret' => md5(AUTH_KEY.SECURE_AUTH_KEY)), site_url()).'" />';							
