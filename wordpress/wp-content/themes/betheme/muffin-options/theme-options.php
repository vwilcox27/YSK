	...
	function mfn_opts_setup(){
		...
		$menu = array(	
			...
			'general' => array(
				...
				'sections' 	=> array( 'general', 'advanced', 'sidebars', 'blog', 'portfolio', 'shop', 'sliders', 'hooks',  'under-construction', 'plugins' ),
			),
			
			// Layout --------------------------------------------
			'elements' => array(
				'title' 	=> __('Layout', 'mfn-opts'),
				'sections' 	=> array( 'layout-general', 'layout-header', 'layout-menu', 'social', 'layout-footer', 'custom-css' ),
			),
		...
		$sections['advanced'] = array(
			...
			'fields' => array(
				...
				array(
					'id' 		=> 'error404-page',
					'type' 		=> 'pages_select',
					'title' 	=> __('Error 404 | Custom Page', 'mfn-opts'),
					'sub_desc' 	=> __('Custom 404 Page Content.<br />Page Options are disabled', 'mfn-opts'),
				...
				array(
					...
					'options' 	=> array(
						...
						'facebook'		=> 'Facebook',
						'disable' 		=> 'Disable prettyPhoto',
					),
				),
					
				array(
					'id' 		=> 'prettyphoto-title',
					'type' 		=> 'switch',
					'title' 	=> __('Pretty Photo | Title', 'mfn-opts'), 
					'desc' 		=> __('Show image alternative text above prettyPhoto frame', 'mfn-opts'), 
					'options' 	=> array( '0' => 'Off', '1' => 'On' ),
					'std' 		=> '0'
				),
				...
				array(
					'id' 		=> 'no-hover',
					'type' 		=> 'select',
					'title' 	=> __('Responsive | Hover Effects', 'mfn-opts'),
					'options' 	=> array(
						'' 			=> 'Always Enabled',
				...
				array(
					'id' 		=> 'no-section-bg',
					'type' 		=> 'select',
					'title' 	=> __('Responsive | Section Background Image', 'mfn-opts'),
					'options' 	=> array(
						'' 			=> 'Always Show',
				...
				array(
					...
					'type' 		=> 'checkbox',
					'title' 	=> __('Responsive | Options', 'mfn-opts'),
					'options' 	=> array(
				...
				array(
					'id' 		=> 'mfn-seo',
					'type' 		=> 'switch',
					'title' 	=> __('SEO | Use built-in fields', 'mfn-opts'), 
				...
				array(
					'id' 		=> 'meta-description',
					'type' 		=> 'text',
					'title' 	=> __('SEO | Meta Description', 'mfn-opts'),
				...
				array(
					'id' 		=> 'meta-keywords',
					'type' 		=> 'text',
					'title' 	=> __('SEO | Meta Keywords', 'mfn-opts'),
					'desc' 		=> __('These setting may be overridden for single posts & pages.', 'mfn-opts'),
				),
		...
		$sections['sidebars'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'desc' 		=> __('Default: 23%<br />Recommended: 20%-30%<br />Too small or too large value may crash the layout', 'mfn-opts'),
					'param'	 	=> array(
						'min' 		=> 10,
						'max' 		=> 50,
					),
		...
		$sections['blog'] = array(
			...
			'fields' => array(
				...
				array(
					'id' 		=> 'blog-author',
					'type' 		=> 'switch',
					'title' 	=> __('Single Post | Author Box', 'mfn-opts'),
				...
				array(
					'id' 		=> 'blog-related',
					'type' 		=> 'switch',
					'title' 	=> __('Single Post | Related Posts', 'mfn-opts'),
				...
				array(
					'id' 		=> 'blog-comments',
					'type' 		=> 'switch',
					'title' 	=> __('Single Post | Comments', 'mfn-opts'),
				...
				array(
					'id' 		=> 'blog-single-zoom',
					'type' 		=> 'switch',
					'title' 	=> __('Single Post | Zoom Image', 'mfn-opts'),
				...
				array(
					...
					'type' 		=> 'text',
					'title' 	=> __('Single Post | Layout ID', 'mfn-opts'),
					'class'		=> 'small-text',
				),
		...
		$sections['portfolio'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'options' 	=> array(
						'flat col-3'	=> array('title' => 'Flat 3 col', 'img' => MFN_OPTIONS_URI.'img/flat.png'),
						'flat col-4'	=> array('title' => 'Flat 4 col', 'img' => MFN_OPTIONS_URI.'img/flat-4.png'),
				...
				array(
					...
					'type' 		=> 'select',
					'title' 	=> __('Portfolio Link', 'mfn-opts'),
					'sub_desc' 	=> __('Portfolio Image and Title Link', 'mfn-opts'),
					'options' 	=> array(
						''			=> 'Details',
						'popup'		=> 'Popup Image',
				...
				array(
					...
					'desc' 		=> __('Must be different from the Portfolio site title chosen above, eg. <b>portfolio-item</b><br /><br />After change go to <b>Settings > Permalinks</b> and click <b>Save changes</b>.', 'mfn-opts'),
					'class' 	=> 'small-text',
					'std' 		=> 'portfolio-item',
				),
				...
				array(
					...
					'sub_desc' 	=> __('Do not use characters not allowed in links', 'mfn-opts'),
					'desc' 		=> __('Must be different from the Portfolio site title chosen above, eg. <b>portfolio-types</b><br /><br />After change go to <b>Settings > Permalinks</b> and click <b>Save changes</b>.', 'mfn-opts'),
					'class' 	=> 'small-text',
					'std' 		=> 'portfolio-types',
				),
		...
		$sections['shop'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'type' 		=> 'radio_img',
					'title' 	=> __('Layout', 'mfn-opts'), 
					'sub_desc' 	=> __('Layout for shop products list', 'mfn-opts'),
					'options' 	=> array(
						'grid'			=> array('title' => 'Grid 3 col', 'img' => MFN_OPTIONS_URI.'img/grid.png'),
						'grid col-4'	=> array('title' => 'Grid 4 col', 'img' => MFN_OPTIONS_URI.'img/grid-4.png'),
						'masonry'		=> array('title' => 'Masonry', 'img' => MFN_OPTIONS_URI.'img/masonry.png'),
						'list'			=> array('title' => 'List', 'img' => MFN_OPTIONS_URI.'img/list.png'),
					),
					'std' 		=> 'grid'																		
				...
				array(
					...
					'options' 	=> array(
						'' 			=> 'Shop Page only',
						'all'		=> 'Shop, Categories & Single Products',
					),
				),
		...
		$sections['under-construction'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'sub_desc' 	=> __('Custom Under Construction Page Content', 'mfn-opts'),
					'desc' 		=> __('Leave this field <b>blank</b> if you want to use <b>default</b> Under Construction page.<br /><b>Notice</b>: Page Options are disabled. Plugins may not work on this page.', 'mfn-opts'),
					'args' 		=> array(),
				),
		...
		$sections['layout-general'] = array(
			...
			'fields' => array(
				...
				array(
					'id'		=> 'logo-img',
					'type'		=> 'upload',
					'title'		=> __('Logo | Custom', 'mfn-opts'),
				),
					
				array(
					'id'		=> 'retina-logo-img',
					'type'		=> 'upload',
					'title'		=> __('Logo | Retina', 'mfn-opts'),
				...
				array(
					'id'		=> 'sticky-logo-img',
					'type'		=> 'upload',
					'title'		=> __('Logo | Sticky Header', 'mfn-opts'),
					'sub_desc'	=> __('optional', 'mfn-opts'),
				...
				array(
					...
					'type'		=> 'upload',
					'title'		=> __('Logo | Sticky Header Retina', 'mfn-opts'),
					'sub_desc'	=> __('optional', 'mfn-opts'),
				...
				array(
					'id' 		=> 'logo-link',
					'type' 		=> 'checkbox',
					'title' 	=> __('Logo | Options', 'mfn-opts'),
					'options' 	=> array(
		...
		$sections['layout-header'] = array(
			...
			'fields' => array(
				...
				array(
					'id'		=> 'header-wpml',
					'type'		=> 'select',
					'title'		=> __('WPML Languages Flags', 'mfn-opts'),
					'options'	=> array(
						''				=> 'Show | Dropdown',
				...
				array(
					'id'		=> 'subheader',
					'type'		=> 'select',
					'title'		=> __('Subheader | Visibility', 'mfn-opts'),
					'options'	=> array(
						'' 				=> 'Default',
				...
				array(
					'id'		=> 'subheader-style',
					'type'		=> 'select',
					'title'		=> __('Subheader | Style', 'mfn-opts'),
					'options'	=> array(
						'' 				=> 'Title on the Left',
				...
				array(
					...
					'type' 		=> 'sliderbar',
					'title' 	=> __('Subheader | Alpha (transparency)', 'mfn-opts'),
				...
				array(
					'id'		=> 'subheader-slider-show',
					'type'		=> 'switch',
					'title'		=> __('Subheader | Show with Slider', 'mfn-opts'),
					'desc'		=> __('Show Subheader on pages with Slider', 'mfn-opts'),
					'options'	=> array( '0' => 'Off', '1' => 'On' ),
					'std'		=> '0',
				),
		...
		$sections['layout-menu'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'options'	=> array(
						''						=> 'Default',
						'arrows'				=> 'Default with submenu arrows',
						'highlight'				=> 'Highlight',
						'highlight menu-arrows'	=> 'Highlight with submenu arrows',
						'hide'					=> 'Hide Menu',
					),
				),
		...
		$sections['content'] = array(
			...
			'fields' => array(
				...
				array(
					'id' 		=> 'button-style',
					'type' 		=> 'select',
					'title' 	=> __('Button | style', 'mfn-opts'), 
					'options' 	=> array(
						''			=> 'Default',
						'stroke'	=> 'Stroke',
					)
