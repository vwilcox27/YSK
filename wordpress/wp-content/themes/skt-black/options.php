...
function optionsframework_options() {
	...
	$section_text = array(
		...
		2 => array(
			...
			'content'		=> '<h3>Do you like SKT Black? Is it everything you wanted from a theme?</h3><div class="clear"></div><a class="contact-button" href="#">Contact Us</a>',
		),
	...
	$options[] = array(
		...
		'id' => 'copytext',
		'std' => '&copy; 2015 SKT Black. All Rights Reserved',
		'type' => 'text');
