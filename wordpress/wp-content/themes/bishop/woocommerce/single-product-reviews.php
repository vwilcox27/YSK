        ...
        <div id="comments">
            ...
            <?php if ( get_option('woocommerce_enable_review_rating') == 'yes' ) {
                ...
                if ( $count > 0 ) {
                    ...
                    echo '<h3>'.sprintf( _n('%s review for this item', '%s reviews for this item', $count, 'yit'), '<span itemprop="ratingCount" class="count">'.$count.'</span>', wptexturize($post->post_title) ).'</h3>';
                    echo '</div>';
