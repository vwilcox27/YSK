...
<head>
    ...
    <?php if( function_exists( 'YIT_Asset' ) ) : ?>
        ...
        <link rel='stylesheet' id='google-fonts-css' href="<?php echo $assets["style"]["google-fonts"]["src"]; ?>?ver=3.9" type="text/css" media="all">
        <link rel='stylesheet' id='cache-dynamics-css'  href='<?php echo $assets["style"]["cache-dynamics"]["src"]; ?>?ver=3.9' type='text/css' media='all' />
        <link rel='stylesheet' id='font-awesome-css'  href='<?php echo $assets["style"]["font-awesome"]["src"]; ?>?ver=3.9' type='text/css' media='all' />
    <?php endif; ?>
