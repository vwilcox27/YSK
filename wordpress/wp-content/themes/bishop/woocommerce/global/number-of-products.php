...
<p id="number-of-products">
    ...
    <a class="view-12<?php if ( $num_prod == $num_prod_x1 ) echo ' active'; ?>" href="<?php echo add_query_arg( 'products-per-page', $num_prod_x1, $link ) ?>"><?php echo $num_prod_x1 ?></a> /
    <a class="view-24<?php if ( $num_prod == $num_prod_x2 ) echo ' active'; ?>" href="<?php echo add_query_arg( 'products-per-page', $num_prod_x2, $link ) ?>"><?php echo $num_prod_x2 ?></a> /
    <a class="view-all<?php if ( $num_prod == 'all' ) echo ' active'; ?>" href="<?php echo add_query_arg( 'products-per-page', 'all', $link ) ?>"><?php _e( 'ALL', 'yit' ) ?></a>
</p>
