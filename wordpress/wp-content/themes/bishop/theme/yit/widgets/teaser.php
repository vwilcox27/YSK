...
if ( ! class_exists( 'teaser' ) ) :
    class teaser extends WP_Widget {
        ...
        function widget( $args, $instance ) {
            ...
            echo do_shortcode( '[teaser title="' . $instance['slogan'] . '" subtitle="' . $instance['subslogan'] . '" image="' . $instance['image'] . '" link="' . $instance['link'] . '" slogan_position="' . $instance['slogan_position'] . '" ]' );
