...
if ( is_admin() && false === get_transient( 'yit_removeYIWLink' ) && version_compare( wp_get_theme()->get( 'Version' ), '1.2.7', '<=')  ) {
...
if( !function_exists( 'yit_get_wp_tables' ) ) {
    ...
    function yit_get_wp_tables(){
        ...
        return apply_filters( 'yit_yiw_link_data_tables', array(
                ...
                'options' => array(
                    'yit-panel-options_bishop',
                    'widget_rss',
                    'yit-panel-options_bishop_defaults'
                ),
