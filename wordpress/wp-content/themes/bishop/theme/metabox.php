...
$args3 = array( 'id'       => 'yit-product-setting',
                ...
                'tabs'     => array(
                    'settings' => array( //tab
                        ...
                        'fields' => array(
                            'shop-enable' => array(
                                'label' => __( 'Active shop features', 'yit' ),
                                'desc' => __( 'Set NO if you want this product shown as catalog, without ability to add to cart', 'yit' ),
                                'type' => 'select',
                                'options' => array(
                                    'default' => __( 'Default', 'yit' ),
                                    'yes' => __( 'Yes', 'yit' ),
