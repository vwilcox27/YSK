...
$background_large=yit_get_option("general-background-color");
if(isset($background_large)) {
    $background_title_large="rgba(".yit_hex2rgb($background_large["color"]).",0.30)";
}

?>

<div class="pricing_box price-table <?php echo $type." ".$class_no_header." ".$price_table_position; ?>">

    <div class="head">
        <?php if($show_header): ?>
            <span class="price"><?php echo $price; ?></span>
            <span class="title" <?php echo ($type=="large") ? "style='background-color:".$background_title_large."'" : ""; ?>><?php echo $title; ?></span>
        <?php endif; ?>
    </div>
