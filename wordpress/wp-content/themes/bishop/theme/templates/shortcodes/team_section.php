        ...
        <div class="team-section">
            ...
            <div class="tabs pagination-post-<?php the_ID() ?> row">
                ...
                foreach( $team_members as $member ):
                    $role = get_post_meta( $member->ID, '_member_role', true );
                ?>
                    <div class="navigation col-md-2 col-sm-3 col-xs-6 <?php if( $first ) echo 'active' ?>">
                        <div class="thumb">
                            <?php
                            if( has_post_thumbnail( $member->ID ) ):
                                yit_image( array(
        ...
        <script>
            jQuery(document).ready(function($) {
                ...
                var teamSwiper = $('.team-<?php the_ID()?>.swiper_container').swiper({
                    ...
                    autoresize: true,
                    resizeReInit:true,
                    simulateTouch: (!yit.isRtl),
                    onSlideChangeStart: function(){
                        $(".tabs .navigation.active").removeClass('active');
                        $(".tabs .navigation").eq(teamSwiper.activeLoopIndex).addClass('active');
