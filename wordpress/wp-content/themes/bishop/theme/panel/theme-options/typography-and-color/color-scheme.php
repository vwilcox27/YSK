...
return array(
    ...
    array(
        ...
        'style'          => array(
            'selectors'  => '.shade-2, #primary .testimonials-slider ul.testimonial-content li p.meta, #primary .testimonials-slider ul.testimonial-content li p.meta a, #primary div.owl-prev:hover i, #primary div.owl-next:hover i,.images-slider-sc ul li a.flex-prev:hover i,.images-slider-sc ul li a.flex-next:hover i,.logos-slider .nav .prev:hover i,.logos-slider .nav .next:hover i,#primary .testimonial-widget .owl-buttons .owl-prev:hover i,#primary .testimonial-widget .owl-buttons .owl-next:hover i, .blog-masonry .masonry-brick .yit_post_content a',
            'properties' => 'color'
        ),
        'in_skin'        => true,
    ),
