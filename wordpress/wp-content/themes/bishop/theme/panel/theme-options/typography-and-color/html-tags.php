...
return array(
    ...
    array(
        ...
        'style' => array(
            'selectors'   => 'h3,.tabs-container ul.tabs li h4 a, .features-tab-container ul.features-tab-labels li h4 a, .yit_shortcodes.last-post h3 a, .widget.widget_bp_core_login_widget.buddypress.widget #bp-login-widget-form .bp-login-widget-register-link a',
            'properties'  => 'font-size,
                              font-family,
                              font-weight,
                              color,
