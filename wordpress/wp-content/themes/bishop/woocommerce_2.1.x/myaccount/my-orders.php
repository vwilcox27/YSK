...
if ( $customer_orders ) { ?>
    ...
    <h2><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'yit' ) ); ?></h2>
    ...
    <table class="shop_table my_account_orders">
        ...
        <tr>
            ...
            <th class="order-date"><span class="nobr"><?php _e( 'Date', 'yit' ); ?></span></th>
            <th class="order-status"><span class="nobr"><?php _e( 'Status', 'yit' ); ?></span></th>
        ...
        foreach ( $customer_orders as $customer_order ) {
            ...
            <td class="order-total">
                <?php echo sprintf( _n( '%s for %s item', '%s for %s items', $item_count, 'yit' ), $order->get_formatted_order_total(), $item_count ); ?>
            </td>
...
<?php } else { ; ?>
    ...
    <p><?php _e( 'There are no orders yet.', 'yit' ); ?></p>
