                ...
                <?php if ( isset( $tabs['search'] ) ): ?>
                    <div id="tabs-panel-<?php echo $model ?>-<?php echo $type ?>-search" class="tabs-panel tabs-panel-inactive">
                        <p class="quick-search-wrap">
                            <input type="search" class="yit-quick-search-<?php echo $model ?> quick-search input-with-default-title " title="Search" value="" name="yit-quick-search-<?php echo $model ?>-<?php echo $type ?>" id="yit-quick-search-<?php echo $model ?>-<?php echo $type ?>" autocomplete="off">
                            <span class="spinner"></span>
                            <input type="submit" name="submit" id="submit-quick-search-<?php echo $model ?>-<?php echo $type ?>" class="button button-small quick-search-submit hide-if-js" value="Search">

                        <div class="clearfix"></div>
                        </p>
                        <ul id="<?php echo $type ?>-search-checklist" data-wp-lists="list:<?php echo $type ?>" class="categorychecklist form-no-clear">
                        </ul>
                    </div>
                <?php endif; ?>
            </div>
