    ...
    <div class="sfm-scroll-wrapper">
        <div class="sfm-scroll">
            ...
            <div class="sfm-logo<?php if(empty($options['sf_tab_logo'])) echo ' sfm-no-image';?>">
                ...
                <?php endif; ?>
                <div class="sfm-title"><?php if(!empty($options['sf_first_line'])) echo '<h3>'.$options['sf_first_line'].'</h3>'; if(!empty($options['sf_sec_line'])) echo '<h4>'.$options['sf_sec_line'].'</h4>';?></div>
            </div>
            <?php
//            global $sitepress;
